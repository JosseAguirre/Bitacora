...
public class SesionBean implements Serializable {
	...
	@EJB
	private ServicioInicioSesion iniciosesion;
	...
	public String mostrarUsuarioLogeado() {
		...
		return us.getAdmEmpleado().getNombres() +" "+ us.getAdmEmpleado().getApellidos(); // retorno el nombre + apellido
	}
	
	public String mostrarnombre() {
		AdmUsuario us = (AdmUsuario) FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("usuario"); //obtengo el usuario logueado
		return "User: "+us.getAdmEmpleado().getNombres() +" "; // retorno el nombre 
	}
	
	public String mostrarapellido() {
		AdmUsuario us = (AdmUsuario) FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("usuario"); //obtengo el usuario logueado
		return "User: "+ us.getAdmEmpleado().getApellidos() +" "; // retorno el apellido
	}
}
